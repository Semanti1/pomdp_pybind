...
import copy
from objectsearch.models.transition_model import *
from objectsearch.models.reward_model import *
from objectsearch.models.components.sensor import *
from objectsearch.domain.state import *
...
class MosEnvironment(Environment):
    """"""
    ...
    def state_transition(self, action, execute=True, robot_id=None):
        ...
        reward = self.reward_model().sample(self.getstate(), action, next_state,
                                          robot_id=robot_id)
        if execute:
